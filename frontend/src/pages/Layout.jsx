...
function Sidebar({ isExpanded, setIsExpanded, className }) {
  const toggleSidebar = () => setIsExpanded(!isExpanded);
  
  return (
    <div
      className={cn(
        "fixed left-0 top-0 flex h-screen flex-col border-r bg-background px-3 py-4 transition-all duration-300",
